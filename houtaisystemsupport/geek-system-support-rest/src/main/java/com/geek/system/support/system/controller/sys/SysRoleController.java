...
import com.geek.system.support.system.dto.sys.SysRoleResourceDto;
...
import com.geek.system.support.system.service.sys.SysRoleScopService;
...
import com.geek.system.support.system.util.RoleConstant;
...
public class SysRoleController extends AppIBaseController {
    ...
    public ResponseParam queryTree(@PathVariable(value = "dataType") String dataType,@RequestBody SysRoleDto sysRoleDto){
        ...
        //执行查询语句
        List<SysRoleEntity> sysRoleEntities = sysRoleService.queryAll(searchParam,new String[]{"num"});
