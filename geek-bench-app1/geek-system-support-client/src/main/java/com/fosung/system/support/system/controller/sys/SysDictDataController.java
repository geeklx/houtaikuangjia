...
import com.fosung.system.support.system.dto.sys.SysDictDataDto;
import com.fosung.system.support.system.entity.sys.SysDictDataEntity;
import com.fosung.system.support.system.service.sys.SysDictDataService;
import com.fosung.system.support.system.service.sys.SysDictDataServiceImpl;
import com.fosung.system.support.system.service.sys.SysDictTypeService;
...
public class SysDictDataController extends AppIBaseController {
    ...
    public ResponseParam queryByRoleId(@RequestBody SysDictDataDto sysDictDataDto){
        if(sysDictDataDto.getProjectId() == null){
            return ResponseParam.success()
     ...
     */
 	@PostMapping("save")
    @SysLog(optModule = "字典管理",optName = "保存字典项",optType = OptLogType.SAVE)
    public ResponseParam save(@RequestBody SysDictDataEntity  sysDictData) {
         //字典做配置时，更新时清除缓存
         if(SysDictDataServiceImpl.CONFIG_DICT.contains(sysDictData.getDictType())){
             stringRedisTemplate.delete(RedisConstant.PROJECT_CONFIG+sysDictData.getProjectId());
         }
        ...
        if(sysDictData.getId() != null){
            ...
            if(!sysDictDataEntity.getDictLabel().equals(sysDictData.getDictLabel())){
                ...
                existParam1.put("projectId",sysDictData.getProjectId());
            ...
            if(!sysDictDataEntity.getDictValue().equals(sysDictData.getDictValue())) {
                ...
                existParam2.put("projectId",sysDictData.getProjectId());
     ...
     */
 	@PostMapping("delete")
    @SysLog(optModule = "字典管理",optName = "删除字典项",optType = OptLogType.DELETE)
    ...
    public ResponseParam queryDictByTypes(@RequestBody SysDictDataEntity sysDictDataEntity){
        ...
        searchParam.put("projectId",sysDictDataEntity.getProjectId());
