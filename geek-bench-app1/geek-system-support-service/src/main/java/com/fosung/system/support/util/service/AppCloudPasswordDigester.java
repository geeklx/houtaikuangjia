package com.fosung.system.support.util.service;

import java.security.MessageDigest;
import java.security.NoSuchAlgorithmException;

public final class AppCloudPasswordDigester {
	 ...
	 */
	public AppCloudPasswordDigester(String algorithm, int iterations) {
