...
public interface SystemAuthApi {
    ...
    ResponseParam resetPassword(@RequestParam String telephone, @RequestParam String password,@RequestParam(value = "projectCode",required = false) String projectCode);
