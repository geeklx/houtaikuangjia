package com.fosung.system.support.system.service.aop;
...
import com.fosung.system.support.system.service.sys.SysLogManageService;
import com.fosung.system.support.system.service.sys.SysUserService;
import com.fosung.system.support.util.IpUtil;
...
public class WebLogAspect extends AppIBaseController {
     ...
     */
    @Pointcut("@annotation(com.fosung.system.support.system.anno.SysLog)")
    public void webLog(){
