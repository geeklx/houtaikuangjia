package com.geek.workbench.rest.controller.sys;
...
import com.geek.workbench.dto.sys.SysDictTypeDto;
import com.geek.workbench.entity.sys.SysDictTypeEntity;
import com.geek.workbench.service.sys.SysDictTypeService;
...
public class SysDictTypeController extends AppIBaseController {
	...
	public ResponseParam query(@RequestBody SysDictTypeDto sysDictTypeDto){
        ...
        //执行分页查询
        Page<SysDictTypeEntity> sysDictTypePage = sysDictTypeService.queryByPage(searchParam , sysDictTypeDto.getPageNum() , sysDictTypeDto.getPageSize()) ;
...
//    @SysLog(optModule = "字典管理",optName = "保存字典",optType = OptLogType.SAVE)
     ...
     */
 	@PostMapping("delete")
    @OptLog(optModule = "字典管理",optName = "删除字典",optType = OptLogConst.DELETE)
    ...
    @OptLog(optModule = "字典管理",optName = "批量启用/禁用",optType = OptLogConst.BATCH_ENABLED)
     ...
     **/
    @PostMapping("copy")
    @OptLog(optModule = "字典管理",optName = "复制",optType = OptLogConst.SAVE)
